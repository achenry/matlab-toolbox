...
% [Req, R] = dequiv(time, data, m)
%
%  MATLAB function to determine the damage equivalent loads (Req)
%    time = time vector,
%    data = loads data array, 
%    m = Wohler curve exponent for material (slope of log(S) vs log(N))
%        Eg. composite: 10-12, steel: 3
%
